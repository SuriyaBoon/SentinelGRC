...
class SupplyChainPolicyTests(unittest.TestCase):
    ...
    def test_all_ci_actions_are_immutable_and_security_assessment_is_retained(self):
        ...
        self.assertIn("CI_RUN_ID: ${{ github.run_id }}", workflow)
        self.assertIn("persist-credentials: false", workflow)
        self.assertNotIn("steps.pip_audit.outcome != 'skipped'", workflow)
        self.assertNotIn("internal-be-careful-output", workflow)
        expected = (
