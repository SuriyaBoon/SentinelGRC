...
class SupplyChainPolicyTests(unittest.TestCase):
    ...
    def test_publication_requires_unprivileged_qualification_and_exact_handoff(self):
        ...
        self.assertIn("runtime_test_modules=$(find .", qualify)
        self.assertIn("sentinelgrc:release -m unittest -v $runtime_test_modules", qualify)
        self.assertIn(
            "test_security_assessment test_supply_chain_policy "
            "test_production_image_closure",
            qualify,
        )
        self.assertNotIn("sentinelgrc-qualification:release -m unittest discover", qualify)
