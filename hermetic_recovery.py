...
def run_pipeline_commit_ack_recovery(repository_root: str | Path) -> dict[str, bool]:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        inbox = root / "inbox"
        inbox.mkdir()
        (inbox / "hermetic-evidence.json").write_text(
        ...
        protected = [
            ...
            root / "runtime" / "remediation" / "hermetic-evidence.json",
            root / "runtime" / "tickets" / "hermetic-evidence.json",
            root / "runtime" / "reports" / "hermetic-evidence.json",
        ]
