...
| Limited Production Pilot | Not started | Requires all live gates, approved scope, capacity/failure-duration evidence, access review, and security/go-live approval. |
...
5. Preserve sanitized, source-bound evidence for every gate, then conduct the
   limited production pilot and request a separate human GO or NO-GO decision.
